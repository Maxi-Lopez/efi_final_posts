...
class User(db.Model, UserMixin):
    ...
    contenidos = db.relationship('Contenido', backref='autor', lazy=True)
...
class Contenido(db.Model):
    ...
    comentarios = db.relationship('Comentario', backref='contenido_rel', lazy=True)
...
class Comentario(db.Model):
    ...
    def __str__(self):
        return f"Comentario de {self.autor_id} en contenido {self.contenido_id}"
